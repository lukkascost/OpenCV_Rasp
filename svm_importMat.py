...
smetodo = ["INTER_LANCZOS4","INTER_LINEAR","INTER_AREA","INTER_CUBIC","INTER_NEAREST"]
de = 1
ate = 39
for metodo in smetodo:
    ...
    plt.title(metodo)
    plt.grid(True)
    plt.savefig("Resultados/graficos-"+metodo+"--"+str(de)+"-a-"+str(ate)+".png",bbox_inches='tight',dpi=400)
    ##plt.show()
    plt.gcf().clear()
